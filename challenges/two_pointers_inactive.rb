...
# Scenario: You want to reorder users so inactive accounts move to the end.

# users = ["active", "inactive", "active", "inactive"]

# Task: Return ["active", "active", "inactive", "inactive"]
